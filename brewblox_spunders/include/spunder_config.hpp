...
std::array<const float,   _NUMBER_OF_SPUNDERS> ESP_VOLTS     = { _ESPV1, _ESPV2, _ESPV3, _ESPV4 };
std::array<const float,   _NUMBER_OF_SPUNDERS> USB_VOLTS     = { _PUSB1, _PUSB2, _PUSB3, _PUSB4 };
